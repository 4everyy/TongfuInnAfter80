...
function drawTitle(ui) {
  ...
  ui.label(profile.innName + ' · ' + profile.townName, 112, 174, 20, ui.theme.colors.gold, 'left', ui.theme.fonts.title);
  ui.portrait('zhangdeng', 574, 88, 142);
  ui.addButton({ type: 'startAdventure' }, 118, 232, 300, 60, '开始游戏', ui.theme.colors.cinnabar);
}
