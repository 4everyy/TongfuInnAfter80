...
var MAP_SPECS = {
  ...
  street: spec(196, [box('left-stalls', 0, 172, .18, 106, 278, 88), box('right-shopfront', .82, 164, .18, 118, 282, 96)], { npcDepths: { 'street-merchant': 232, 'street-townsman': 280, 'npcv26-noodle-vendor-ma': 288, 'npcv26-map-seller-ye': 304 } }),
  ...
  guild_warehouse: spec(220, [box('left-crates', 0, 224, .25, 90, 314, 78), box('scale-platform', .40, 212, .17, 62, 274, 56), box('right-crates', .74, 210, .26, 104, 314, 92)], { npcAnchors: { 'npcv26-warehouse-foreman-dou': [.771, 244, 'left'] }, npcDepths: { 'guild-clerk': 256, 'npcv26-warehouse-foreman-dou': 244 } }),
  ...
  canal_checkpoint: spec(202, [box('left-barrier', 0, 222, .18, 74, 296, 64), box('canal', .31, 258, .23, 68, 326, 0, false), box('checkpoint-rail', .58, 250, .07, 68, 318, 60), box('right-water', .70, 258, .13, 68, 326, 0, false), box('right-watch', .84, 170, .16, 112, 282, 96)], { floorBottom: 318, hotspotAnchors: { 'c06-chain-barrier': [.50, 250], 'c06-checkpoint-fight': [.50, 250], 'c06-finale': [.50, 286] } }),
  ...
  jiangnan_dock: spec(194, [box('left-water', 0, 186, .18, 118, 304, 0, false), box('left-cargo', .18, 224, .18, 62, 286, 56), box('crane-cart', .45, 206, .15, 66, 272, 58), box('right-water', .82, 186, .18, 118, 304, 0, false), box('right-cargo', .68, 224, .14, 62, 286, 56), box('front-water', .18, 304, .64, 44, 348, 0, false)], { floorBottom: 304, walk: [[.18, 194, .82, 304]], hotspotAnchors: { 'c10-delayed-cargo': [.64, 294], 'c10-banquet-fight': [.64, 294] }, npcAnchors: { 'npcv26-porter-alu': [.622, 294, 'left'], 'npcv26-boatwoman-he': [.697, 300, 'left'] }, npcSlots: { 'dock-clerk': [.46, 294] } }),
